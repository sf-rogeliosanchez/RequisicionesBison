...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="form1" runat="server">
        <div style="text-align: left;width:900px;" class="main">
            <br /><br />
            Usuario :<br />
            <asp:TextBox ID="TextBox1" runat="server"  CssClass="textEntry"></asp:TextBox><br /><br />
            Contraseña :<br />
            <asp:TextBox ID="TextBox2" runat="server" CssClass="passwordEntry" TextMode="Password"></asp:TextBox><br /><br />
